...
PCTall = zeros(nAmp,nIter,length(selType),nCellDraws,length(cellType)); % (na,nj,nt,nd,nc)
% Models (all)
...
set(gca,'XLim',[15 maxDrawEXC],'YLim',[20 80],'YTick',20:10:80,'XTick',15:15:120);
plot([15 maxDrawEXC],[20 20],'r--');
...
xlabel('Neurons used','FontName','Arial');
title('Frequency decoding accuracy by selectivity type','FontName','Arial');
set(gca,'XLim',[15 maxDrawEXC],'YLim',[20 84],'YTick',20:10:100,'XTick',15:15:120);
plot([15 maxDrawEXC],[20 20],'r--');
